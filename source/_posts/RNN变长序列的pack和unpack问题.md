---
title: RNN变长序列的pack和unpack问题
date: 2020-01-26 14:11:39
mathjax: true
categories:
- pytorch备忘录
tags:
...
> [原文章](https://github.com/HarshTrivedi/packing-unpacking-pytorch-minimal-tutorial)讲的非常简单易懂，这里直接复制粘贴了，以便随时查阅。**重点就是要对序列长度进行降序排序，还有就是要设置一个padding，比如num_embeddings = num_words + 1， 其中第0个位置作为padding填充序列。**
